...
import Helpers.util
import Helpers.classificationMethod
import math

class NaiveBayesClassifier(Helpers.classificationMethod.ClassificationMethod):
    """
    ...
    def trainAndTune(self, trainingData, trainingLabels, validationData, validationLabels, kgrid):
        ...
        commonPrior = Helpers.util.Counter() # probability over labels
        commonConditionalProb = Helpers.util.Counter() # Conditional probability of feature feat being 1
                                      # indexed by (feat, label)
        commonCounts = Helpers.util.Counter() # how many time I have seen feature feat with label y
        ...
        for k in kgrid: # Smoothing parameter tuning loop!
            prior = Helpers.util.Counter()
            conditionalProb = Helpers.util.Counter()
            counts = Helpers.util.Counter()
